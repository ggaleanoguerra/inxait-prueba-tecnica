        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-4">
                <a href="{{ route('lotteries.participants.download.all') }}" target="_blank"
                    ...
                    <button class="text-black transition duration-200 flex items-center space-x-2">
                        <x-icons.excel class="h-5 w-5" />
                        <span class="text-amber-500">Exportar TODOS los participantes</span>
                    </button>
                </a>
                <a href="{{ route('lotteries.create') }}"
                    title="Crear sorteo">
                    <button class=" transition duration-200 flex items-center space-x-2">
                        <x-icons.edit class="h-5 w-5" />
                        <span class="text-amber-500">Crear sorteo</span>
                    </button>
                </a>
            </div>
        </div>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex justify-end space-x-2">
                                                <a href="{{ route('lotteries.edit', ['id' => $entity->id]) }}"
                                                    >
                                                    <button
                                                        class="p-2 bg-transparent hover:bg-gray-800 text-gray-100 rounded transition duration-200"
                                                        title="Editar sorteo">
                                                        <x-icons.edit class="h-5 w-5 text" />
                                                    </button>
                                                </a>
                                                <a href="{{ route('lotteries.participants', ['id' => $entity->id]) }}"
                                                    title="Parcipantes del sorteo">
                                                    <button
                                                        class="p-2 bg-transparent hover:bg-gray-800 text-gray-100 rounded transition duration-200">
                                                        <x-icons.eye class="h-5 w-5 text-gray-400" />
                                                    </button>
                                                </a>
                                                <a href="{{ route('get.winners', ['id' => $entity->id]) }}"
                                                    title="Ganadores del sorteo">
                                                    <button
                                                        class="p-2 bg-transparent hover:bg-gray-800 text-gray-100 rounded transition duration-200 flex items-center">
                                                        <x-icons.people class="h-5 w-5 text-gray-400" />
                                                    </button>
                                                </a>
                                                <a href="{{ route('lotteries.sorteo', ['id' => $entity->id]) }}"
                                                    class="btn-sorteo">
                                                    <button
                                                        class="p-2 bg-transparent hover:bg-gray-800 text-gray-100 rounded transition duration-200"
                                                        title="Realizar sorteo">
                                                        <x-icons.random class="h-5 w-5 text" />
                                                    </button>
                                                </a>

                                                <a href="{{ route('lotteries.participants.download', ['id' => $entity->id]) }}"
