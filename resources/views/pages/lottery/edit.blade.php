        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-900 border border-gray-800 overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-100">
                    <form method="POST" action="{{ route('lotteries.update', $entity->id) }}"
                        ...
                        <div class="flex justify-center mt-8">
                            <button type="submit"
                                class="lottery-submit-btn inline-flex items-center px-6 py-3 bg-amber-500 text-black font-medium rounded hover:bg-amber-400 transition duration-200">
                                <span class="mr-2">{{ __('Actualizar Sorteo') }}</span>
